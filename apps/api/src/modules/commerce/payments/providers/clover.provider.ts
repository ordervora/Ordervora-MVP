...
/**
 * Stub — registered per Sprint 07 spec §4 ("Clover, Square, Authorize.net,
 * Adyen, and Fiserv are registered stub adapters"), same treatment as
 * modules/imports/adapters/doordash.adapter.ts. `implemented: false`
 * lets the registry/owner dashboard show it as visible-but-unavailable
 * without hardcoding a provider-type list anywhere else.
 */
export class CloverPaymentProviderAdapter implements PaymentProviderAdapter {
  readonly providerType = PaymentProviderType.CLOVER;
